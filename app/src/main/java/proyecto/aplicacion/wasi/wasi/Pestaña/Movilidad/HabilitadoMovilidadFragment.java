...
public class HabilitadoMovilidadFragment extends Fragment implements View.OnClickListener {
    private RecyclerView listaMovilidadHabilitados;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_movilidad_habilitado, container, false);

        listaMovilidadHabilitados = (RecyclerView) view.findViewById(R.id.listaMovilidadHabilitado);
